...
namespace planetaryEscapeCa3
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
      ...
      //  public VibrateController vibrator = VibrateController.Default;
     ...
     //   AdManager showAd;
        ...
        public bool EnableMusic
        {
            ...
            set {
                ...
                //UpdateSetting("enableMusic", enableMusic);
        ...
        {
            get { return enableSoundFx; }

            set
            {
                enableSoundFx = value;
                // Save our setting everytime we change the setting
                //UpdateSetting("enableSoundFx", enableSoundFx);
                //// Save the settings so it is committed.
                //SaveSettings();
            }
            ...
            : base(game)
        {
            ...
            //enableSoundFx = GetSetting("enableSoundFx", true);
        ...
        protected override void LoadContent()
        {
            ...
            //adDuplex = new AdManager(Game, "112311");
